...
public protocol WSAuthenticationDelegate: WSResponseProtocol {
...
@available(*, deprecated, message: "Anilist's v1 API was disabled on May 1st, 2018")
public class WSAuthentication: WSBase {
    public var delegate: WSAuthenticationDelegate?
    ...
    public func getAccess(using grantType: GrantType) {
