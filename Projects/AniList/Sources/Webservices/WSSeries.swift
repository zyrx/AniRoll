...
@objc public protocol WSSeriesDelegate: WSResponseProtocol {
...
@available(*, deprecated, message: "Anilist's v1 API was disabled on May 1st, 2018")
public class WSSeries: WSBase {
    
    public var delegate: WSSeriesDelegate?
    
    /// Basic - Returns a series model.
    /// @link http://anilist-api.readthedocs.io/en/latest/series.html#basic
    public func getSeries(type serieType: SerieType, user id: String) {
    ...
    public func getPage(series: String, user id: String) {
    ...
    public func getCharacters(type characterType: CharacterType, series: String, user id: String) {
    ...
    public func airing(user id: String) {
    ...
    public func browse(type serieType: SerieType, parameters browseParameters: BrowseParameters? = nil) {
    ...
    public func toggleFavourite(type serieType: SerieType, id: Int) {
    ...
    public func search(type serieType: SerieType, query: String) {
