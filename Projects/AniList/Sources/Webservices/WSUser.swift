...
@objc public protocol WSUserDelegate: WSResponseProtocol {
...
public class WSUser: WSBase {
    ...
    public func getUserActivity(id: Int? = nil, page: Int? = nil) {
        let id = id ?? 0
    ...
    public func setActivity(type activity: Activity) {
    ...
    public func userNotifications(count: Bool = false) {
    ...
    public func followList(type followList: FollowList, id: Int) {
    ...
    public func toggleFollow(id: Int) {
    ...
    public func favourites(user id: Int) {
    ...
    public func airing(limit: Int? = nil) {
